    ...
    return (
        <div>
            ...
            <div>
                ...
                {onePage?.siteAdditionalFunctionality && !!onePage?.siteAdditionalFunctionality.length && onePage?.siteAdditionalFunctionality.map((item) => (
                    <ul key={item?.name}>
                    <li>- {item?.name}</li>
                    </ul>
                ))}
            ...
            <div>
                ...
                {onePage?.siteAdditionalServices && !!onePage?.siteAdditionalServices.length && onePage?.siteAdditionalServices.map((item) => (
                    <ul key={item?.name}>
                        <li>- {item?.name}</li>
                    </ul>
                ))}
